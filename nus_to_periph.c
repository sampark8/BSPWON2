...
#define DEVICE_NAME                     "BSP_Won_Central"                         /**< Name of device. Will be included in the advertising data. */
...
static nus_to_periph_on_data_received_t m_on_data_received = 0;
...
static void nus_data_handler(ble_nus_evt_t * p_evt)
{
    ...
    if (p_evt->type == BLE_NUS_EVT_RX_DATA)
    {
        ...
        {
            m_on_data_received(p_evt->params.rx_data.p_data, p_evt->params.rx_data.length);
        }
